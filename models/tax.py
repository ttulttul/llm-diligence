...
class TaxAssessment(TaxDocument):
...
class TaxIncentiveDocument(TaxDocument):
...
class TransferPricingDocument(TaxDocument):
...
class PropertyTaxDocument(TaxDocument):
...
class CustomsDocument(TaxDocument):
